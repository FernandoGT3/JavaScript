...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --primary-color:rgb(45, 152, 167);\n}\n\n*{\n    margin: 0;\n    box-sizing: border-box;\n}\n\nbody{\n    padding: 0;\n    outline: none;\n    background-color: var(--primary-color);\n    font-family: sans-serif;\n    font-size: 1.3rem;\n    line-height: 1.5;\n}\n\n.container{\n    max-width: 640px;\n    margin: 50px auto;\n    padding: 50px;\n    background-color: rgb(255, 255, 255);\n    border-radius: 20px;\n    box-shadow: 10px 10px 5px gray;\n}\n\n.form input, .form label, .form button{\n    display: block;\n    width: 100%;\n    margin-bottom: 10px;\n}\n\n.form input{\n    font-size: 24px;\n    height: 50px;\n    padding: 0 20px;\n    border: 1px solid var(--primary-color);\n    border-radius: 15px;\n}\n\n.form input:focus{\n    outline: 2px solid var(--primary-color);\n}\n\n.form button{\n    border: none;\n    border-radius: 30px;\n    height: 50px;\n    font-size: 18px;\n    font-weight: 700;\n    background-color: var(--primary-color);\n    color: white;\n    cursor: pointer;\n    transition: all 300ms ease-in-out;\n    margin-top: 30px;\n}\n\n.form button:hover{\n    color:  var(--primary-color);\n    background-color: white;\n}", "",{"version":3,"sources":["webpack://./frontend/assets/css/styles.css"],"names":[],"mappings":"AAAA;IACI,iCAAiC;AACrC;;AAEA;IACI,SAAS;IACT,sBAAsB;AAC1B;;AAEA;IACI,UAAU;IACV,aAAa;IACb,sCAAsC;IACtC,uBAAuB;IACvB,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,aAAa;IACb,oCAAoC;IACpC,mBAAmB;IACnB,8BAA8B;AAClC;;AAEA;IACI,cAAc;IACd,WAAW;IACX,mBAAmB;AACvB;;AAEA;IACI,eAAe;IACf,YAAY;IACZ,eAAe;IACf,sCAAsC;IACtC,mBAAmB;AACvB;;AAEA;IACI,uCAAuC;AAC3C;;AAEA;IACI,YAAY;IACZ,mBAAmB;IACnB,YAAY;IACZ,eAAe;IACf,gBAAgB;IAChB,sCAAsC;IACtC,YAAY;IACZ,eAAe;IACf,iCAAiC;IACjC,gBAAgB;AACpB;;AAEA;IACI,4BAA4B;IAC5B,uBAAuB;AAC3B","sourcesContent":[":root{\n    --primary-color:rgb(45, 152, 167);\n}\n\n*{\n    margin: 0;\n    box-sizing: border-box;\n}\n\nbody{\n    padding: 0;\n    outline: none;\n    background-color: var(--primary-color);\n    font-family: sans-serif;\n    font-size: 1.3rem;\n    line-height: 1.5;\n}\n\n.container{\n    max-width: 640px;\n    margin: 50px auto;\n    padding: 50px;\n    background-color: rgb(255, 255, 255);\n    border-radius: 20px;\n    box-shadow: 10px 10px 5px gray;\n}\n\n.form input, .form label, .form button{\n    display: block;\n    width: 100%;\n    margin-bottom: 10px;\n}\n\n.form input{\n    font-size: 24px;\n    height: 50px;\n    padding: 0 20px;\n    border: 1px solid var(--primary-color);\n    border-radius: 15px;\n}\n\n.form input:focus{\n    outline: 2px solid var(--primary-color);\n}\n\n.form button{\n    border: none;\n    border-radius: 30px;\n    height: 50px;\n    font-size: 18px;\n    font-weight: 700;\n    background-color: var(--primary-color);\n    color: white;\n    cursor: pointer;\n    transition: all 300ms ease-in-out;\n    margin-top: 30px;\n}\n\n.form button:hover{\n    color:  var(--primary-color);\n    background-color: white;\n}"],"sourceRoot":""}]);
// Exports
